...
const ShapeGrid = ({
  ...
  squareSize = 40,
  hoverFillColor = '#222',
  shape = 'hexagon', // 'hexagon', 'triangle', 'circle', or 'square'
  hoverTrailAmount = 0,
  className = ''
}) => {
  ...
  useEffect(() => {
    ...
    // Menambahkan gridLineWidth ke dependency array
  }, [direction, speed, borderColor, gridLineWidth, hoverFillColor, squareSize, shape, hoverTrailAmount]);
